...
(defun zenburn-format-spec-works-p ()
  (and (fboundp 'format-spec)
       (= (next-property-change
           0 (format-spec #("<%x>" 0 4 (face (:weight normal)))
                          '((?x . "foo"))) 4) 4)))
  ...
  (color-theme-install
   (append
    (list 'color-theme-zenburn
     ...
     `(zenburn-primary-1 ((t (:foreground ,zenburn-yellow :weight normal))))
     `(zenburn-primary-2 ((t (:foreground ,zenburn-orange :weight normal))))
     '(zenburn-primary-3 ((t (:foreground "#dfdfbf" :weight normal))))
     '(zenburn-primary-4 ((t (:foreground "#dca3a3" :weight normal))))
     '(zenburn-primary-5 ((t (:foreground "#94bff3" :weight normal))))
     ...
     '(zenburn-title ((t (:inherit variable-pitch :weight normal))))
     ...
     '(diff-index ((t (:inherit normal))))
     '(diff-file-header ((t (:inherit normal))))
     ...
     '(erc-nick-default ((t (:inherit normal))))
     ...
     '(circe-originator-face ((t (:inherit normal))))
     ...
     '(eshell-ls-archive ((t (:foreground "#c3bf9f" :weight normal))))
     '(eshell-ls-backup ((t (:inherit font-lock-comment))))
     '(eshell-ls-clutter ((t (:inherit font-lock-comment))))
     `(eshell-ls-directory ((t (:foreground ,zenburn-blue+1 :weight normal))))
     `(eshell-ls-executable ((t (:foreground ,zenburn-red+1 :weight normal))))
     '(eshell-ls-unreadable ((t (:inherit zenburn-lowlight-1))))
     '(eshell-ls-missing ((t (:inherit font-lock-warning))))
     '(eshell-ls-product ((t (:inherit font-lock-doc))))
     '(eshell-ls-special ((t (:inherit zenburn-primary-1))))
     `(eshell-ls-symlink ((t (:foreground ,zenburn-cyan :weight normal))))
...
;;      (gnus-cite-5 ((t (:foreground ,zenburn-red-3))))
     ...
     '(font-latex-normal ((t (:inherit normal))))
